...
1. Mude os arquivos para que os arquivos virem um módulo que recebe a quantidade de nós no load balancer OK
2. Monte o arquivo que chama o módulo recem criado. OK
3. Adicione estado remoto no S3 no arquivo que chama os módulos. OK
